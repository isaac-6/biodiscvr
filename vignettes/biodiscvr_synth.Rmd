...
This allows you to run the entire pipeline and understand the inputs, outputs, and capabilities of `biodiscvr`.
...
```{r define_paths_synth_vignette, eval=FALSE}
...
pkg_synth_experiments_file <- system.file("files", "experiments_synth.yaml", package = "biodiscvr", mustWork = FALSE) # Not used in this vignette
pkg_synth_literature_defs_file <- system.file("files", "literature_biomarkers_synth.yaml", package = "biodiscvr", mustWork = FALSE) # Not used in this vignette
...
```{r load_and_preprocess_synth_merged_v2, eval=FALSE}
# Load raw data
...
```{r demographics_synth_v3, eval=FALSE}
...
```{r single_cohort_discovery_synth_v3, eval=FALSE}
