...
Runs the experiments defined in the package-internal `experiments.yaml`. **This step can take a long time.** For this vignette, the chunk is set to `eval=FALSE`. Copy the code and run it in your own script for actual analysis.
